...
const Sidebar = () => {
  return (
    <div className="hidden lg:flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          <a
            className="flex items-center px-4 py-2 text-gray-700 bg-gray-200 rounded-md dark:bg-gray-700 dark:text-teal"
            href="/"
          >
            <svg
              className="w-5 h-5"
          ...
          <a
            ...
            href="/"
          >
            <ImCoinDollar color="rgb(55 65 81)" fontSize="1.25rem" />

            <span className="mx-4 font-medium">Crypto Coins</span>
          </a>
